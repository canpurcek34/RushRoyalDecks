...
@Composable
fun Clans(navController: NavHostController) {
        ...
        content = {
            ...
            Card(
                ...
                Row(modifier = Modifier.padding(start = 15.dp,end = 15.dp, top = 10.dp, bottom = 10.dp)) {
                    Text(text = "List of clans in Rush Royale")

                }
                Row(modifier = Modifier.padding(start = 15.dp,end = 15.dp, top = 10.dp, bottom = 10.dp)) {
                    Text(text = "The list of the most active English-speaking clans, like your clan every day and promote it to the top of the list!")
